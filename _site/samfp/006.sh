...
#      - You gave nsteps   = 1
#      - You gave nframe   = 1
#      - You gave exptim per channel             = 90 seconds
#      - Readout time per exposure               = 3 seconds 
#      - Total exposure time (whole observation) = 105.4 minutes
#      - Total exposure time (whole observation) = 1.75667 hours
#      - You gave binxy                          = 4 
#      - You gave the basename                   = p609_obs
...
set exptim = 90.0
set binxy = 4
set basename = "p609_obs"
set cmd = `sami dhe set image.dir /home2/images/SAMFP/20170301/006`
