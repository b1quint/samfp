...
#      - The name of the object                         : HD303056
...
#      - You gave nsteps   = 1
#      - You gave nframe   = 1
#      - You gave exptim per channel             = 120.000 seconds
#      - Readout time per exposure               = 2.000 seconds 
#      - Total exposure time (whole observation) = 81.333 minutes
#      - Total exposure time (whole observation) = 1.356 hours
#      - You gave binxy                          = 4 
...
set cmd = `sami dhe set image.dir /home2/images/SAMFP/20170301/005`
