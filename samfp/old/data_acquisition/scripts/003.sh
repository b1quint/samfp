...
#      - The name of the object                         : NGC2818
...
#      - You gave nsteps   = 1
#      - You gave nframe   = 1
#      - You gave exptim per channel             = 60.000 seconds
#      - Readout time per exposure               = 2.000 seconds 
#      - Total exposure time (whole observation) = 41.333 minutes
#      - Total exposure time (whole observation) = 0.689 hours
#      - You gave binxy                          = 4 
#      - You gave the basename                   = fp_samiA
...
set exptim = 60.0
set binxy = 4
set basename = "fp_samiB"
set cmd = `sami dhe set image.dir /home2/images/SAMFP/20170301/003`
